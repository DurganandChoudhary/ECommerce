        ...
        <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10'>
          ...
          <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            <div className="lg:col-span-2">
              <h1 className="text-lg lg:text-xl front-semibold text-gray-900">METRONAUT</h1>
              <h1 className='text-lg lg:text-xl text-gray-900 opacity-60 pt-1'>
                Casual Regular Sleeves Printed Women Multicolor Top
              </h1>
            </div>
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className='flex space-x-5 item-center text-lg lg:text-xl text-gray-900 mt-6'>
                <p className='font-semibold'> ₹379</p>
              ...
              <div className="mt-6">
                <div className='flex items-center space-x-3'>
                  ...
                  <p className='opacity-50 text-sm'>6487 Ratings</p>
                  <p className='ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500'>578 Reviews</p>
                </div>
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <div className='flex items-center space-x-3'>
                  ...
                  <p className='opacity-60'>59874 Ratings</p>
                </div>
                ...
                <Box className="mt-5 space-y-3">
                  ...
                  <Grid container alignItems="center" gap={2}>
                    ...
                    <Grid item xs={7}>
                      <LinearProgress sx={{bgcolor:"#dododo", borderRadius:4, height:7, color:"yellow"}}
